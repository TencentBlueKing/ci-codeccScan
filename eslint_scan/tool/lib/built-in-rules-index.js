...
module.exports = {
    ...
    "comment-ratio": require("./rules/comment-ratio"),
    ...
    "func-id-match": require("./rules/func-id-match"),
    ...
    "space-indent": require("./rules/space-indent"),
